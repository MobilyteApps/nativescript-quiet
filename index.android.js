...
var FrameTransmitterConfig = org.quietmodem.Quiet.FrameTransmitterConfig;
var FrameTransmitter = org.quietmodem.Quiet.FrameTransmitter;
export class NativescriptQuiet extends NativescriptQuietCommon {
    static sendMessage(message, profile) {
        try {
    ...
    static async receiveMessage(profile) {
